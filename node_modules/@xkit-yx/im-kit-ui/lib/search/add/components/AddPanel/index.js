...
var AddPanel = function (_a) {
    var trigger = _a.trigger, onClick = _a.onClick, _b = _a.prefix, prefix = _b === void 0 ? 'search' : _b;
    ...
    var content = (react_1.default.createElement("div", { onClick: function () { return setVisible(false); } },
        react_1.default.createElement(AddList_1.default, __assign({}, props))));
    return (react_1.default.createElement("div", { className: _prefix },
        react_1.default.createElement(antd_1.Popover, { content: content, trigger: trigger, visible: visible, onVisibleChange: handleVisibleChange, placement: "bottom" },
            react_1.default.createElement("div", { className: "".concat(_prefix, "-btn") },
                react_1.default.createElement(common_1.CommonIcon, { className: "".concat(_prefix, "-btn-img"), type: "icon-tianjiaanniu" })))));
};
