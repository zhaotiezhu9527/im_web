...
var AddFriendModal = (0, mobx_react_1.observer)(function (_a) {
    ...
    var _e = __read((0, react_1.useState)(''), 2), searchValue = _e[0], setSearchValue = _e[1];
    ...
    var handleAdd = function () { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    _a.sent();
                    antd_1.message.success(t('applyFriendSuccessText'));
                    return [3 /*break*/, 4];
                case 2: return [4 /*yield*/, store.friendStore.addFriendActive(searchRes.account)];
                case 3:
                    _a.sent();
                    antd_1.message.success(t('addFriendSuccessText'));
                    _a.label = 4;
                case 4:
                    setAdding(false);
                    return [3 /*break*/, 6];
    ...
    return (react_1.default.createElement(antd_1.Modal, { className: _prefix, title: t('addFriendText'), onCancel: handleCancel, visible: visible, width: 460, footer: !searchRes ? renderFooter() : null },
        react_1.default.createElement(common_1.SearchInput, { placeholder: t('accountPlaceholder'), prefix: commonPrefix, onChange: handleChange, value: searchValue }),
        searchResEmpty ? (react_1.default.createElement("div", { className: "".concat(_prefix, "-empty-content") }, t('accountNotMatchText'))) : searchRes ? (react_1.default.createElement("div", { className: "".concat(_prefix, "-content") },
            react_1.default.createElement(common_2.CrudeAvatar, { avatar: searchRes.avatar, nick: searchRes.nick, account: searchRes.account }),
            react_1.default.createElement("div", { className: "".concat(_prefix, "-info") },
                react_1.default.createElement("div", { className: "".concat(_prefix, "-info-name") }, searchRes.nick || searchRes.account),
                react_1.default.createElement("div", { className: "".concat(_prefix, "-info-account") }, searchRes.account)),
            store.uiStore.getRelation(searchRes.account) !== 'stranger' ? (react_1.default.createElement(antd_1.Button, { type: "primary", onClick: handleChat }, t('chatButtonText'))) : (react_1.default.createElement(antd_1.Button, { loading: adding, type: "primary", onClick: handleAdd }, t('addButtonText'))))) : null));
});
