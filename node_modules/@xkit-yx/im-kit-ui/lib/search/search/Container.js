...
exports.SearchContainer = (0, mobx_react_1.observer)(function (_a) {
    ...
    return (react_1.default.createElement("div", { className: "".concat(_prefix, "-wrapper") },
        react_1.default.createElement("div", { className: "".concat(_prefix, "-wrapper-button"), onClick: handleOpenModal },
            react_1.default.createElement(icons_1.SearchOutlined, null),
            react_1.default.createElement("span", { className: "".concat(_prefix, "-wrapper-text") }, t('searchInputPlaceholder'))),
        react_1.default.createElement(SearchModal_1.default, { visible: visible, friends: store.uiStore.friendsWithoutBlacklist, teams: store.uiStore.teamList, onCancel: function () { return setVisible(false); }, prefix: prefix, onResultItemClick: handleChat, renderEmpty: renderEmpty, renderSearchResultEmpty: renderSearchResultEmpty, commonPrefix: commonPrefix })));
});
