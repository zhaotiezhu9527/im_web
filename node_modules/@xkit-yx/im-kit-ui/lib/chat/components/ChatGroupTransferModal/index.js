...
var GroupTransferModal = function (_a) {
    ...
    var _c = __read((0, react_1.useState)(''), 2), selectedMemberId = _c[0], setSelectedMemberId = _c[1]; // 选中的成员 ID
    ...
    var handleOk = function () { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    _a.sent();
                    antd_1.message.success(t('transferTeamSuccessText'));
                    onOk();
                    return [3 /*break*/, 3];
                case 2:
                    error_1 = _a.sent();
                    switch (error_1 === null || error_1 === void 0 ? void 0 : error_1.code) {
                        ...
                        case 802:
                            ...
                            break;
                        default:
                            antd_1.message.error(t('transferTeamFailedText'));
                            break;
                    }
                    return [3 /*break*/, 3];
    ...
    var itemAvatarRender = function (data) {
        return (react_1.default.createElement(common_1.ComplexAvatarContainer, { prefix: commonPrefix, canClick: false, account: data.key, size: 32 }));
    };
    return (react_1.default.createElement(common_2.SelectModal, { title: t('transferOwnerText'), searchPlaceholder: t('searchTeamMemberPlaceholder'), leftTitle: t('teamMemberText'), visible: visible, datasource: datasource, itemAvatarRender: itemAvatarRender, onSelectChange: handleSelect, type: "radio", min: 1, okText: t('okText'), onOk: handleOk, onCancel: handleCancel, prefix: commonPrefix }));
};
exports.default = GroupTransferModal;
