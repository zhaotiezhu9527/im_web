...
var ChatSettingDrawer = function (_a) {
    ...
    //   return <></>
    // }
    return (react_1.default.createElement(antd_1.Drawer, { width: 357, getContainer: false, className: "".concat(_prefix, "-wrap"), title: title, placement: "right", closable: false, maskClosable: true, open: visible, keyboard: true, onClose: onClose, extra: react_1.default.createElement(icons_1.CloseOutlined, { onClick: onClose, type: "primary" }) }, children));
};
exports.default = ChatSettingDrawer;
