...
var ConversationList_1 = require("./components/ConversationList");
var common_1 = require("../common");
var package_json_1 = __importDefault(require("../../package.json"));
var mobx_react_1 = require("mobx-react");
exports.ConversationContainer = (0, mobx_react_1.observer)(function (_a) {
    ...
    var _d = (0, common_1.useStateContext)(), nim = _d.nim, store = _d.store, initOptions = _d.initOptions, localOptions = _d.localOptions;
    ...
    // 处理 team 会话列表 @ 提醒
    var _e = __read((0, react_1.useState)([]), 2), sessionList = _e[0], setSessionList = _e[1];
    ...
    return (react_1.default.createElement(ConversationList_1.ConversationList, { sessions: sessionList, 
        // loading={loading}
