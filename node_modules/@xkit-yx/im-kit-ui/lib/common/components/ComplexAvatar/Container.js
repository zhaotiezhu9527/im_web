...
exports.ComplexAvatarContainer = void 0;
var react_1 = __importStar(require("react"));
var ComplexAvatarUI_1 = require("./ComplexAvatarUI");
var antd_1 = require("antd");
var useStateContext_1 = require("../../hooks/useStateContext");
var useTranslation_1 = require("../../hooks/useTranslation");
var mobx_react_1 = require("mobx-react");
exports.ComplexAvatarContainer = (0, mobx_react_1.observer)(function (_a) {
    ...
    var _d = (0, useStateContext_1.useStateContext)(), store = _d.store, localOptions = _d.localOptions;
            ...
            switch (_a.label) {
                ...
                case 5:
                    ...
                    if (localOptions.addFriendNeedVerify) {
                        antd_1.message.error(t('applyFriendFailedText'));
                    }
                    else {
                        antd_1.message.error(t('addFriendFailedText'));
                    }
                    return [3 /*break*/, 6];
            ...
            onOk: function () { return __awaiter(void 0, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        ...
                        case 1:
                            _a.sent();
                            antd_1.message.success(t('deleteFriendSuccessText'));
                            setVisible(false);
                            afterDeleteFriend === null || afterDeleteFriend === void 0 ? void 0 : afterDeleteFriend(account);
                            return [3 /*break*/, 3];
                        case 2:
                            error_2 = _a.sent();
                            antd_1.message.error(t('deleteFriendFailedText'));
                            return [3 /*break*/, 3];
    ...
    var handleOnBlockFriendClick = function () { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    _a.sent();
                    antd_1.message.success(t('blackSuccessText'));
                    setVisible(false);
                    afterBlockFriend === null || afterBlockFriend === void 0 ? void 0 : afterBlockFriend(account);
                    return [3 /*break*/, 3];
                case 2:
                    error_3 = _a.sent();
                    antd_1.message.error(t('blackFailedText'));
                    return [3 /*break*/, 3];
                case 3: return [2 /*return*/];
            }
        });
