...
var ChatForwardModal = function (_a) {
    ...
    var _d = __read((0, react_1.useState)(''), 2), comment = _d[0], setComment = _d[1];
    var _e = __read((0, react_1.useState)(false), 2), isSearching = _e[0], setIsSearching = _e[1];
    ...
    var itemAvatarRender = function (data) {
        var _a = (0, utils_1.parseSessionId)(data.key), scene = _a.scene, to = _a.to;
        if (scene === 'p2p') {
            return (react_1.default.createElement(common_1.ComplexAvatarContainer, { prefix: commonPrefix, canClick: false, account: to, size: 32 }));
        }
        if (scene === 'team') {
            var team = store.teamStore.teams.get(to);
            return (react_1.default.createElement(common_1.CrudeAvatar, { account: to, avatar: (team === null || team === void 0 ? void 0 : team.avatar) || '', nick: (team === null || team === void 0 ? void 0 : team.name) || '', size: 32 }));
        }
        return null;
    };
    ...
    var handleOk = function (data) { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    _a = (0, utils_1.parseSessionId)(data[0].key), scene = _a.scene, to = _a.to;
                ...
                case 3:
                    error_1 = _b.sent();
                    antd_1.message.error(t('forwardFailedText'));
                    throw error_1;
                case 4: return [2 /*return*/];
            }
        });
    }); };
    return (react_1.default.createElement(common_1.SelectModal, { title: t('forwardText'), visible: visible, datasource: datasource, itemAvatarRender: itemAvatarRender, onSearchChange: function (value) {
            setIsSearching(!!value);
        }, type: "radio", min: 1, okText: t('sendBtnText'), searchPlaceholder: t('searchInputPlaceholder'), leftTitle: t(isSearching ? 'searchText' : 'recentSessionText'), rightTitle: t('sendToText'), bottomRenderer: react_1.default.createElement(antd_1.Input, { className: "".concat(_prefix, "-input"), placeholder: t('commentText'), allowClear: true, value: comment, onChange: handleCommentChange }), onOk: handleOk, onCancel: onCancel, prefix: commonPrefix }));
};
exports.default = ChatForwardModal;
