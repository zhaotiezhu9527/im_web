...
exports.MsgListContainer = void 0;
var react_1 = __importStar(require("react"));
var MsgList_1 = require("./components/MsgList");
var common_1 = require("../../common");
var package_json_1 = __importDefault(require("../../../package.json"));
var mobx_react_1 = require("mobx-react");
var antd_1 = require("antd");
var utils_1 = require("../../utils");
exports.MsgListContainer = (0, mobx_react_1.observer)(function (_a) {
    ...
    var _e = __read((0, react_1.useState)(false), 2), applyTeamLoaidng = _e[0], setApplyTeamLoaidng = _e[1];
    var _f = __read((0, react_1.useState)(false), 2), teamInviteLoading = _f[0], setTeamInviteLoading = _f[1];
    var _g = __read((0, react_1.useState)(false), 2), applyFriendLoading = _g[0], setApplyFriendLoading = _g[1];
    var onAcceptApplyTeamClick = function (options) {
        setApplyTeamLoaidng(true);
        store.teamStore
            .passTeamApplyActive(options)
            .then(function () {
            antd_1.message.success(t('acceptedText'));
            afterAcceptApplyTeam === null || afterAcceptApplyTeam === void 0 ? void 0 : afterAcceptApplyTeam(options);
        })
            .catch(function (err) {
            antd_1.message.error(t('acceptFailedText'));
            utils_1.logger.error('同意该申请失败: ', err);
        })
            .finally(function () {
    ...
    var onRejectApplyTeamClick = function (options) {
        ...
        store.teamStore
            ...
            .then(function () {
            antd_1.message.success(t('rejectedText'));
            afterRejectApplyTeam === null || afterRejectApplyTeam === void 0 ? void 0 : afterRejectApplyTeam(options);
        })
            .catch(function (err) {
            antd_1.message.error(t('rejectFailedText'));
            utils_1.logger.error('拒绝该申请失败: ', err);
        })
            .finally(function () {
            setApplyTeamLoaidng(false);
        });
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 2:
                    error_1 = _a.sent();
                    antd_1.message.error(t('acceptFailedText'));
                    utils_1.logger.error('同意该申请失败: ', error_1);
                    return [3 /*break*/, 4];
                case 3:
